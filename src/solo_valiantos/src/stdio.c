...
void putc(char c)
{
    // print_char is a function that prints a single character on the screen.
    print_char(c);
}
...
//writes a character to the VGA text mode buffer.
void print_char(char c)
{
    // `vga_buffer` is a pointer to the VGA text mode buffer
